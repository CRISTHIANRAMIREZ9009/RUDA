...
-- Volcando datos para la tabla gepad.ambientedeaprendizaje: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla gepad.banco: ~10 rows (aproximadamente)
/*!40000 ALTER TABLE `banco` DISABLE KEYS */;
INSERT INTO `banco` (`codigobanco`, `nombrebanco`) VALUES
	(1, 'BANCOLOMBIA'),
	(2, 'BANCO AGRARIO'),
	(3, 'DAVIVIENDA'),
	(4, 'BANCO POPULAR'),
...
-- Volcando datos para la tabla gepad.centro: ~116 rows (aproximadamente)
...
INSERT INTO `centro` (`codigocentro`, `nombrecentro`, `direccioncentro`, `ciudadcentro`, `codigoregionalcentro`, `documentofuncionariocentro`) VALUES
	(9101, 'CENTRO DE LOS RECURSOS NATURALES RENOVABLES LA SAL', 'CARRERA 59', 'MEDELLIN', 2, NULL),
	(9103, 'CENTRO PARA EL DESARROLLO AGROECOLÓGICO Y AGROINDU', 'CARRERA. 43 #42-40', 'BARRANQUILLA', 4, NULL),
	(9104, 'CENTRO AGROEMPRESARIAL Y MINERO', 'KM1 VÍA TURBACO', 'TERNERA', 5, NULL),
	(9105, 'CENTRO INTERNACIONAL NÁUTICO FLUVIAL Y PORTUARIOS', 'KM5 VIA MAMONAL', 'CARTAGENA', 5, NULL),
	(9110, 'CENTRO DE DESARROLLO AGROPECUARIO Y AGROINDUSTRIAL', 'KM 1 VÍA PANTANO DE VARGAS', 'DUITAMA', 6, NULL),
	(9111, 'CENTRO MINERO', 'VÍA CENTRO NACIONAL MINERO', 'SOGAMOSO', 6, NULL),
	(9112, 'CENTRO PARA LA FORMACIÓN CAFETERA', 'CIUDADELA TECNOLÓGICA LOS CEREZOS KM 10 VÍA LA MAG', 'MANIZALES', 7, NULL),
	(9113, 'CENTRO AGROPECUARIO', 'Cr 9 No 71 N 60 ALTO CAUCA - KM 7 VÍA CALI', 'POPAYAN', 10, NULL),
	(9114, 'CENTRO BIOTECNOLÓGICO DEL CARIBE', 'VÍA FINCA LAS GRAZAS', 'VALLEDUPAR', 11, NULL),
	(9115, 'CENTRO AGROPECUARIO Y  DE BIOTECNOLOGÍA EL PROVENI', 'KM 42 SANTA ISABEL', 'MONTERIA', 13, NULL),
	(9116, 'CENTRO DE FORMACIÓN AGROINDUSTRIAL LA ANGOSTURA', 'KM 38 VÍA AL SUR', 'CAMPO ALEGRE', 17, NULL),
	(9117, 'CENTRO AGROINDUSTRIAL DEL META', 'KM 1 VÍA ACACIAS', 'VILLAVICENCIO', 20, NULL),
	(9118, 'CENTRO ACUICOLA Y AGROINDUSTRIAL DE GAIRA', 'AV FERROCARRIL #27-97', 'SANTA MARTA', 19, NULL),
	(9119, 'CENTRO DE ATENCION L SECTOR AGROPECUARIO', 'KM 2 VÍA PALOGORDO GUATIGUARA', 'PIE DE CUESTA', 22, NULL),
	(9120, 'CENTRO AGROINDUSTRIAL', 'AV.CENTENARIO #42NORTE 02', 'ARMENIA', 24, NULL),
	(9121, 'CENTRO DE ATENCION AL SECTOR AGROPECUARIO', 'CRA 8A#26-79', 'PEREIRA', 25, NULL),
	(9122, 'CENTRO DE ATENCION AL SECTOR AGROPECUARIO', 'KM 2 PALO GORDO', 'PIE DE CUESTA', 27, NULL),
	(9123, 'CENTRO AGROPECUARIO LA GRANJA', 'KM 5 VÍA ESPINAL', 'IBAGUE', 29, NULL),
	(9124, 'CENTRO AGROPECUARIO DE BUGA', 'CARRERA 21 #1 SUR-399 a 1 SUR-589, GUADALAJARA DE ', 'BUGA', 30, NULL),
	(9125, 'CENTRO LATINOAMERICANO DE ESPECIES MENORES', 'KM2 VIA BUGA TULUA', 'TULUA', 30, NULL),
	(9126, 'CENTRO NÁUTICO PESQUERO DE BUENAVENTURA', 'AV. SIMÓN BOLIVAR KM. 5 BUENAVENTURA', 'BUENAVENTURA', 30, NULL),
	(9201, 'CENTRO DE DISEÑO Y MANUFACTURA DEL CUERO', 'CALLE 63 Nº 58B 03 CALATRAVA', 'ITAGÜÍ', 2, NULL),
	(9202, 'CENTRO DE FORMACIÓN EN DISEÑO, CONFECCIÓN Y MODA', 'CALLE 63 N° 58B-03 CALATRAVA', 'ITAGÜÍ', 2, NULL),
	(9203, 'CENTRO PARA EL DESARROLLO DEL HÁBITAT Y LA CONSTRU', 'No 69, CL. 104 #65120', 'MEDELLIN', 2, NULL),
	(9204, 'CENTRO DE LA TECNOLOGÍA DE LA MANUFACTURA AVANZADA', 'CRA. 68 #104', 'MEDELLIN', 2, NULL),
	(9205, 'CENTRO TECNOLÓGICO DEL MOBILIARIO', 'CALLE 63N° 58B-03 CALATRAVA', 'ITAGÜÍ', 2, NULL),
	(9206, 'CENTRO TECNOLÓGICO DE GESTION INDUSTRIAL', 'CALLE104 #69-120 PEDREGAL', 'MEDELLIN', 2, NULL),
	(9207, 'CENTRO NACIONAL COLOMBO-ALEMÁN', 'CALLE 30 N° 3E-164', 'BARRANQUILLA', 4, NULL),
	(9208, 'CENTRO INDUSTRIAL Y DE AVIACIÓN ', 'CALLE 30 N° 3E-164', 'BARRANQUILLA', 4, NULL),
	(9209, 'CENTRO DE TECNOLOGÍAS PARA LA CONSTRUCCIÓN Y LA MA', 'CRA 18A#2-18 SUR', 'BOGOTÁ', 14, NULL),
	(9210, 'CENTRO DE ELECTRICIDAD, ELECTRÓNICA Y TELECOMUNICA', 'CRA 30#17B-25 SUR', 'BOGOTÁ', 14, NULL),
	(9211, 'CENTRO DE GESTIÓN INDUSTRIAL', 'CALLE 15#3142', 'BOGOTÁ', 14, NULL),
	(9212, 'CENTRO DE MANUFACTURAS EN TEXTILES Y CUERO', 'CRA 30#17B-25 SUR', 'BOGOTÁ', 14, NULL),
	(9213, 'CENTRO DE TECNOLOGÍAS DEL TRANSPORTE', 'CRA 79#40A-51 SUR', 'BOGOTÁ', 14, NULL),
	(9214, 'CENTRO METALMECÁNICO', 'CRA 30#17B-25 SUR', 'BOGOTÁ', 14, NULL),
	(9215, 'CENTRO DE MATERIALES Y ENSAYOS', 'AV. 30#17B-25SUR', 'BOGOTÁ', 14, NULL),
	(9216, 'CENTRO DE DISEÑO Y METROLOGÍA', 'CALLE 15#31-42 TORRE OCCIDENTAL', 'BOGOTÁ', 14, NULL),
	(9217, 'CENTRO PARA LA INDUSTRIA DE LA COMUNICACIÓN GRÁFIC', 'CALLE 15#3542', 'BOGOTÁ', 14, NULL),
	(9218, 'CENTRO PARA LA INDUSTRIA PETROQUÍMICA', 'AV. PEDRO DE HEREDIA SECTOR TESCA', 'CARTAGENA', 5, NULL),
	(9219, 'CENTRO DE AUTOMATIZACIÓN INDUSTRIAL', 'CIUDADELA TECNOLÓGICA LOS CEREZOS KM 10 VÍA LA MAG', 'MANIZALES', 7, NULL),
	(9220, 'CENTRO DE PROCESOS INDUSTRIALES', 'CIUDADELA TECNOLÓGICA LOS CEREZOS KM 10 VÍA LA MAG', 'MANIZALES', 7, NULL),
	(9221, 'CENTRO DE TELEINFORMÁTICA Y PRODUCCIÓN INDUSTRIAL', 'CRA 9#71N60', 'POPAYAN', 10, NULL),
	(9222, 'CENTRO INDUSTRIAL Y DE ENERGÍAS ALTERNATIVAS', 'CALLE 21AV. AEROPUERTO', 'RIOACHA', 18, NULL),
	(9223, 'CENTRO DE DISEÑO E INNOVACION TECNOLOGICA IDUSTRIA', 'DIAG. 27A', 'DOSQUEBRADAS', 25, NULL),
	(9224, 'CENTRO INDUSTRIAL DE MANTENIMIENTO INDUSTRIAL', 'KM 7 VÍA FLORIDA BLANCA', 'RINCON DE GIRON', 27, NULL),
	(9225, 'CENTRO INDUSTRIAL DEL DISEÑO Y LA MANUFACTURA', 'KM 6 AUTOPISTA FLORIDA BLANCA#50-33', 'FLORIDA BLANCA', 27, NULL),
	(9226, 'CENTRO DE INDUSTRIA Y LA CONSTRUCCION', 'TRANS. 1#42-244', 'IBAGUE', 29, NULL),
	(9227, 'CENTRO DE ELECTRICIDAD Y AUTOMATIZACIÓN INDUSTRIAL', 'CALLE 52 #2 BIS-1 a 2 BIS-169', 'CALI', 30, NULL),
	(9228, 'CENTRO DE LA CONSTRUCCIÓN', 'CALLE 34 #17c-2 a 17c-58', 'CALI', 30, NULL),
	(9229, 'CENTRO DE DISEÑO TECNOLÓGICO INDUSTRIAL', 'EL PONDAJE, #26i, CL. 72 #228', 'CALI', 30, NULL),
	(9230, 'CENTRO NACIONAL DE ASISTENCIA TÉCNICA A LA INDUSTR', 'ESQUINA CARRERA 2,Cl. 52 #2BIS-15', 'CALI', 30, NULL),
	(9231, 'CENTRO PARA EL DESARROLLO TECNOLOGICO DE LA CONSTR', 'CALLE 44 NORTE 02', 'ARMENIA', 24, NULL),
	(9232, 'CENTRO INDUSTRIAL Y DESARROLLO EMPRESARIAL SOACHA', 'CALLE 20#69B-57', 'SOACHA', 14, NULL),
	(9301, 'CENTRO DE COMERCIO', 'CALLE 51 N° 57-70 TORRE SUR AV. FERROCARRIL', 'MEDELLIN', 2, NULL),
	(9302, 'CENTRO DE COMERCIO Y SERVICIOS', 'CRA 43 N° 42-40 PISO2', 'BARRANQUILLA', 4, NULL),
	(9303, 'CENTRO DE LA GESTIÓN DE MERCADOS, LOGÍSTICA Y TECN', 'CARACAS#13-65', 'BOGOTÁ', 14, NULL),
	(9304, 'CENTRO DE COMERCIOS Y SERVICIOS', 'KM 1 VÍA TURBACO', 'TERNERA', 5, NULL),
	(9305, 'CENTRO DE GESTIÓN ADMIISTRATIVA Y FORTALECIMIENTO ', 'CARRERA 11', 'SOGAMOSO', 6, NULL),
	(9306, 'CENTRO DE COMERCIO Y SERVICIOS', 'CIUDADELA TECNOLÓGICA LOS CEREZOS KM 10 VÍA LA MAG', 'MANIZALES', 7, NULL),
	(9307, 'CENTRO DE COMERCIOS Y SERVICIOS CAUCA', 'CL 4 N°2-80', 'POPAYAN', 10, NULL),
	(9308, 'CENTRO DE COMERCIOS Y SERVICIOS', 'CRA 8A#26-79', 'PEREIRA', 25, NULL),
	(9309, 'CENTRO DE SERVICIOS EMPRESARIALES Y TURISTICOS', 'CRA 27#15-07', 'BARRANCABERMEJA', 27, NULL),
	(9310, 'CENTRO DE COMERCIO Y SERVICIOS', 'TRANS. 1#42-244', 'IBAGUE', 29, NULL),
	(9311, 'CENTRO DE GESTÓN TECNOLÓGICA DE SERVICIOS', 'CL. 14 Nte. #945', 'CALI', 30, NULL),
	(9401, 'CENTRO DE SERVICIOS DE SALUD', 'CALLE 57 #51D-2 a 51D-116', 'MEDELLIN', 2, NULL),
	(9402, 'CENTRO DE SERVICIOS Y GESTION EMPRESARIAL', 'CRA 46#56-11 AV.ORIENTAL', 'MEDELLIN', 2, NULL),
	(9403, 'CENTRO DE FORMACIÓN DE TALENTO HUMANO EN SALUD', 'CRA 6#45-42', 'BOGOTÁ', 14, NULL),
	(9404, 'CENTRO DE GESTIÓN ADMINISTRATIVA', 'LA CAPUCHINA', 'BOGOTÁ', 14, NULL),
	(9405, 'CENTRO DE SERVICIOS FINANCIEROS', 'CRA 13#65-10', 'BOGOTÁ', 14, NULL),
	(9501, 'COMPLEJO TECNOLÓGICO PARA LA GESTION AGROEMPRESARI', 'TRANSVERSAL 16 N°33-102 DIAGONAL HOSPITAL C.U.P', 'CAUCASIA', 2, NULL),
	(9502, 'COMPLEJO TECNOLÓGICO MINERO AGROEMPRESARIAL', 'CALLE50 LA MALENA', 'PUERTO BERRIO', 2, NULL),
	(9503, 'CENTRO DE LA INNOVACIÓN, LA AGROINDUSTRIA Y EL TUR', 'VARIANTE VIA LA UNION', 'LA CEJA', 2, NULL),
	(9504, 'COMPLEJO TECNOLÓGICO AGROINDUSTRIAL, PECUARIO Y TU', 'KM 1 VÍA TURBO', 'APARTADÓ', 2, NULL),
	(9506, 'CENTRO NACIONAL DE HOTELERÍA, TURISMO Y ALIMENTOS', 'CALLE 15#31-42', 'BOGOTÁ', 14, NULL),
	(9508, 'CENTRO DE GESTIÓN Y FORTALECIMIENTO SOCIOEMPRESARI', 'TRANS. 78J#41D-15 SUR', 'BOGOTÁ', 14, NULL),
	(9509, 'CENTRO DE DESARROLLO AGROINDUSTRIAL Y EMPRESARIAL ', 'CALLE 2 #133', 'VILLETA', 14, NULL),
	(9510, 'CENTRO AGROECOLÓGICO Y EMPRESARIAL', 'AV. MANUEL HUMBERTO CÁRDENAS VÉLEZ, CALLE 16', 'FUSAGASUGÁ', 14, NULL),
	(9511, 'CENTRO DE LA TECNOLOGÍA DEL DISEÑO Y LA PRODUCTIVI', 'CRA 10#30-04 B/MAGDALENA', 'GIRARDOT', 14, NULL),
	(9512, 'CENTRO DE BIOTECNOLOGÍA AGROPECUARIO', 'CALLE 17', 'MOSQUERA', 14, NULL),
	(9513, 'CENTRO DE DESARROLLO AGROEMPRESARIAL', 'CRA 9#11-34', 'CHÍA', 14, NULL),
	(9514, 'CENTRO INDUSTRIAL DE MANTENIMIENTO Y MANUFACTURA', 'CARRERA 12 N°55A-51 ', 'SOGAMOSO', 6, NULL),
	(9515, 'CENTRO PECUARIO Y AGROEMPRESARIAL', 'CRA 1 CALLE 42 ALFONSO LÓPEZ', 'LA DORADA', 7, NULL),
	(9516, 'CENTRO TECNOLÓGICO DE LA AMAZONÍA', 'KM 3 VÍA AEROPUERTO FLORENCIA', 'FLORENCIA', 8, NULL),
	(9517, 'CENTRO PARA LA BIODIVERSIDAD Y EL TURISMO DEL AMAZ', 'CALLE 12 No. 10-60', 'LETICIA', 1, NULL),
	(9518, 'CENTRO AGROFORESTAL Y ACUICOLA ARAPAIMA', 'CALLE 19A#23-57', 'PUERTO ASIS', 23, NULL),
	(9519, 'CENTRO AGROINDUSTRIAL Y FORTALECIMIENTO EMPRESARIA', 'CRA 19 N° 6-68 AEROCIVIL', 'YOPAL', 9, NULL),
	(9520, 'CENTRO AGROEMPRESARIAL', 'CARRERA 40 KM 1 VÍA B/MANGA', 'VALLEDUPAR', 11, NULL),
	(9521, 'CENTRO DE OPERACIÓN Y MANTENIMIENTO MINERO', 'CRA 19 ENTRE CALLES 14 Y 15', 'VALLEDUPAR', 11, NULL),
	(9522, 'CENTRO DE RECURSOS NATURALES, INDUSTRIA Y BIODIVER', 'CRA 1A N° 28-71', 'QUIBDO', 12, NULL),
	(9523, 'CENTRO DE COMERCIO, INDUSTRIA Y TURISMO DE CÓRDOBA', 'AV.CIRCUNVALAR ENTRE CALLES 24 Y 27', 'MONTERIA', 13, NULL),
	(9524, 'CENTRO AGROEMPRESARIAL Y ACUÍCOLA', 'KM 1 SALIDA A BARRANCAS', 'FONSECA', 18, NULL),
	(9525, 'CENTRO AGROEMPRESARIAL Y DESARROLLO PECUARIO DEL H', 'CRA 1#48-42', 'NEIVA', 17, NULL),
	(9526, 'CENTRO DE DESARROLLO AGROEMPRESARIAL Y TURÍSTICO D', 'CRA 7 CON CALLE 6 ESQ.#5-67', 'LA PLATA', 17, NULL),
	(9527, 'CENTRO DE LA INDUSTRIA, LA EMPRESA Y LOS SERVICIOS', 'CALLE 68', 'NEIVA', 17, NULL),
	(9528, 'CENTRO DE GESTIÓN Y DESARROLLO SOSTENIBLE SURCOLOM', 'CRA8#7-53 CENTRO', 'PITALITO', 17, NULL),
	(9529, 'CENTRO DE LOGISTICA Y PROMOCION ECOTURISTICA DEL M', 'AV FERROCARRIL#27-97', 'SANTA MARTA', 19, NULL),
	(9530, 'CENTRO DE GESTIÓN Y DESARROLLO AGROINDUSTRIAL DE A', 'CARRERA 20 No. 28-163', 'ARAUCA', 3, NULL),
	(9531, 'CENTRO DE PRODUCCION Y TRANSFORMACION AGROINDUSTRI', 'CRA 10#15-71 B/ LA PRIMAVERA', 'PUERTO CARREÑO', 32, NULL),
	(9532, 'CENTRO DE INDUSTRIA Y SERVICIOS META', 'KM 1 VÍA ACACIAS', 'VILLAVICENCIO', 20, NULL),
	(9533, 'CENTRO DE DESARROLLO AGROINDUSTRIAL, TURÍSTICO Y T', 'CRA 24#7-10B CENTRO SANJOSE', 'SAN JOSE', 16, NULL),
	(9534, 'CENTRO SURCOLOMBIANO DE LOGISTICA INTERNACIONAL', 'CRA 7#24A-48', 'IPIALES', 21, NULL),
	(9535, 'CENTRO AGROINDUSTRIAL Y PESQUERO DE LA COSTA PACIF', 'KM 21 VÍA TUMACO', 'INGUAPI LA CHIRICANA', 21, NULL),
	(9536, 'CENTRO INTERNACIONAL DE PRODUCCION LIMPIA LOPE', 'CALLE 22#11E-05', 'PASTO', 21, NULL),
	(9537, 'CENTRO DE LA INDUSTRIA, LA EMPRESA Y LOS SERVICIOS', 'CALLE 2N AV. 4 Y 5 PESCADERO', 'CUCUTA', 22, NULL),
	(9538, 'CENTRO DE COMERCIO, INDUSTRIA Y TURISMO', 'CALLE 44 NORTE 02', 'ARMENIA', 24, NULL),
	(9539, 'CENTRO DE FORMACION TURISTICA, GENTE DE MAR Y DE S', 'AV. FRANSCISCO NEWBALL', 'SAN ANDRES', 26, NULL),
	(9540, 'CENTRO INDUSTRIAL Y DEL DESARROLLO TECNOLOGICO', 'CRA 28#56-17 B/GALAN GOMEZ', 'BARRANCABERMEJA', 27, NULL),
	(9541, 'CENTRO AGROTURISTICO', 'CALLE 22#9-82', 'MALAGA', 27, NULL),
	(9542, 'CENTRO DE LA INNOVACION LA TECNOLOGIA Y LOS SERVIC', 'AV. MARISCAL', 'SINCELEJO', 28, NULL),
	(9543, 'CENTRO DE TECNOLOGÍAS AGROINDUSTRIALES DE CARTAGO', 'CRA. 9 #12141', 'CARTAGO', 30, NULL),
	(9544, 'CENTRO DE BIOTECNOLÓGIAS  INDUSTRIAL', 'CALLE 41 #30-1 a 30-129', 'PALMIRA', 30, NULL),
	(9545, 'CENTRO AGROEMPRESARIAL Y TURISTICO DE LOS ANGELES', 'CRA 11#13-13 ', 'MALAGA', 27, NULL),
	(9546, 'CENTRO DE GESTION AGROEMPRESARIAL DEL ORIENTE', 'TRANS. 8#8A-50', 'VELEZ', 27, NULL),
	(9547, 'CENTRO AMBIENTAL Y ECOTURÍSTICO DEL NORORIENTE AMA', 'TRANS. 6A#29A55 VÍA AL COCO', 'INÍRIDA', 15, NULL),
	(9548, 'CENTRO AGROPECUARIO Y DE SERVICIOS AMBIENTALES JIR', 'AV. 15#6-176 SANJOSE', 'MITU', 31, NULL),
	(9549, 'COMPLEJO TECNOLÓGICO TURÍSTICO Y AGROINDUSTRIAL DE', 'CALLE 11 N°12-42 CALLE DE LA AMARGURA', 'SANTA FÉ', 2, NULL);
...
-- Volcando datos para la tabla gepad.fichatitulacion: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla gepad.funcionario: ~0 rows (aproximadamente)
